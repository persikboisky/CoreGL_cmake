...
namespace core
{
	namespace vulkan
	{
		...
		private:
			...
			CommandPool(const CommandPoolCreateInfo& info);

		public:
			~CommandPool();

			static CommandPool create(const CommandPoolCreateInfo& info);
			static CommandPool *ptrCreate(const CommandPoolCreateInfo& info);
		};
	} // vulkan
} // core
