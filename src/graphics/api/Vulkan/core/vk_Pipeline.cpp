...
namespace core
{
	namespace vulkan
	{
		...
		GraphicsPipeline::GraphicsPipeline(const GraphicsPipelineCreateInfo& info) : ptrDevice(&info.ptrDevice->device)
		{
		...
		GraphicsPipeline GraphicsPipeline::create(const GraphicsPipelineCreateInfo& info)
		{
			return GraphicsPipeline(info);
		}

		GraphicsPipeline* GraphicsPipeline::ptrCreate(const GraphicsPipelineCreateInfo& info)
		{
