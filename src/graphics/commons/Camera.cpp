...
namespace core
{
    ...
    Camera Camera::create(float posX, float posY, float posZ, float fov, float distance)
    {
    ...
    Camera* Camera::ptrCreate(float posX, float posY, float posZ, float fov, float distance)
    {
